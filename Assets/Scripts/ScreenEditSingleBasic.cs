...
public class ScreenEditSingleBasic : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Vector2 labelSize = highlightStyle.CalcSize(new GUIContent("Single Basic Layout (Green Score: XX)"));
        ...
        SceneController.Instance.SingleBasicScore = greenScore;
    }
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(rectLayoutLabel, "Single Basic Layout (Green Score: " + greenScore + ")", highlightStyle);
